...
void i2c_start(void)
{
	TWCR = ((1 << TWEA) | (1 << TWEN) | (1 << TWSTA) | (1 << TWINT));	//A TWI start is initiated by setting the following bits on TWCR
								//TWEN - TWI enable
...
void i2c_stop(void)
{
	TWCR = ((1 << TWEA) | (1 << TWEN) | (1 << TWSTO) | (1 << TWINT));	//A TWI start is initiated by setting the following bits on TWCR
								//TWEN - TWI enable
