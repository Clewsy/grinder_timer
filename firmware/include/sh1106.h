#include <stdint.h>
#include "i2c.h"
#include <util/delay.h>		//Needed to use _delau_ms() for the test pattern.

//#include <avr/io.h>

#define OLED_ADDR_WRITE 0b01111000

#define OLED_ADDR			0x7A	//0b0111100	// i2c address of the OLED SSD1306 driver module.
#define OLED_CONTROL_BYTE_COMMAND 	0x80	//0b10000000	// Control byte - indicates that the next byte will be a command.
#define OLED_CONTROL_BYTE_DATA		0x40	//0b11000000	// Control byte - indicates that the next byte will be "data" (i.e. graphical data).
...
#define OLED_SET_CHARGE_PUMP_DEFAULT			0x10 //0x14	// Enable by default - 0x14.  (To disable, use 0x10 to disable).
...
#define OLED_SET_VCOMH_DESELECT_LEVEL_DEFAULT		0x40	// I.e. ~0.77xVcc.
